let greeting = "Hello Awesome Person! You are so faaaaabulous!"

let message = "'Twas the night before Christmas."
message.split("t")

let letters = ['D', 'o', 'p', 'e', 'y']
letters.join('')

let searchMe = ['love', 'peace', 'chocolate', 'ice cream']
console.log(searchMe[(Math.floor(Math.random() * 3))]);
...
function reverse_items(){
	...
	let value1 = searchMe[option1];
	let value2 = searchMe[option2];
	searchMe[option1]=value2;
	searchMe[option2]=value1;
